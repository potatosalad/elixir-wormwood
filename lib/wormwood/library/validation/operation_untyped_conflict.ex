defmodule Wormwood.Library.Validation.OperationUntypedConflict do
  @moduledoc false

  alias Wormwood.Library.Validation.OperationUntyped.AmbiguousFieldSelectionError, as: AmbiguousFieldSelectionError
